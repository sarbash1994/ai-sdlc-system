...
export async function runCommitteeDebate(params: {
  ...
  const agents = [
    ...
    },
    {
      ...
      role: "You are a Senior Fullstack Developer. Your role is to perform thorough code reviews, focusing on best practices, architecture, scalability, and maintainability. You collaborate closely with Backend and Frontend Developers to ensure the implementation meets the highest standards."
    },
    {
      name: "QA Automation",
